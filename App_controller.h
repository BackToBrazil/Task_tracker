...
namespace task_tracker {
	...
	public:
		App_controller(const Task_manager& task_manager, const Task_storage& task_storage, const Console_view& console_view) : m_task_manager{task_manager},
	...
	private:
		...
		const Console_view& m_console_view;
	};
}